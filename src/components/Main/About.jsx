    ...
    <section id="about" className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          {/* Content Column */}
          <div>
            <h3 className="text-2xl font-bold mb-4">A passionate Web Developer based in New York</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              I'm a full-stack developer with a passion for creating interactive, responsive, and user-friendly
              websites. With over 5 years of experience in web development, I specialize in building modern web
              applications using React, Node.js, and other cutting-edge technologies.
            </p>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              My journey in tech started when I built my first website at the age of 16. Since then, I've been
              constantly learning and improving my skills to stay up-to-date with the latest technologies and best
              ...
              {[
                {
                  ...
                  description: "Leading the frontend development team and implementing modern UI/UX designs.",
                },
                {
                  year: "2020 - 2023",
                ...
                },
                {
                  ...
                  description: "Started my professional journey building responsive websites and e-commerce platforms.",
                },
                {
                  year: "2017",
                  title: "Computer Science Degree",
                  company: "Tech University",
                  description: "Graduated with honors in Computer Science with a focus on web technologies.",
                },
              ].map((item, index) => (
                <div
                  key={index}
                ...
                >
                  <div className={`hidden md:block w-5/12 ${index % 2 === 0 ? "text-right" : ""}`}>
                    {index % 2 === 0 ? (
                      <>
                        <h4 className="text-xl font-semibold">{item.title}</h4>
                        <p className="text-[#15e2e5] font-medium">{item.company}</p>
                  ...
                  <div className={`md:w-5/12 w-full ${index % 2 === 1 ? "md:text-right" : ""}`}>
                    <span className="text-gray-500 font-semibold md:hidden block mb-1">{item.year}</span>
                    {index % 2 === 1 ? (
                      <>
                        <h4 className="text-xl font-semibold">{item.title}</h4>
                        <p className="text-[#15e2e5] font-medium">{item.company}</p>
                      ...
                      <>
                        <span className="text-gray-500 font-semibold hidden md:block">{item.year}</span>
